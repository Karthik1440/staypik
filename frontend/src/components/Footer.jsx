        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4 text-left">
            ...
            <div className="flex space-x-3.5 pt-2">
              <a href="https://www.facebook.com/profile.php?id=61593158542954" className="w-8 h-8 rounded-full bg-slate-800 hover:bg-amber-600 text-white flex items-center justify-center transition-all duration-350 shadow-inner hover:scale-110" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/staypikofficial?utm_source=qr" className="w-8 h-8 rounded-full bg-slate-800 hover:bg-amber-600 text-white flex items-center justify-center transition-all duration-350 shadow-inner hover:scale-110" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/staypik.in/" className="w-8 h-8 rounded-full bg-slate-800 hover:bg-amber-600 text-white flex items-center justify-center transition-all duration-350 shadow-inner hover:scale-110" aria-label="LinkedIn">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
